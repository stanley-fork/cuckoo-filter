...
using Config64 =
    CuckooConfig<uint64_t, 8, 500, 256, 16, XorAltBucketPolicy, EvictionPolicy::DFS, uint64_t>;
using Config32 =
    CuckooConfig<uint64_t, 8, 500, 256, 16, XorAltBucketPolicy, EvictionPolicy::DFS, uint32_t>;
